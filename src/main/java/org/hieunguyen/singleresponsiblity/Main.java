...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        IUserPersistence userPersistence = new UserPersistenceService();
        IUserValidation userValidation = new UserValidator();
        UserController controller = new UserController(userPersistence, userValidation);
